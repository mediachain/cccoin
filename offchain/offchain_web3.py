...
def doit():
    ...
    if False:
        ## Each time the client receieves a unmined transaction the `new_transaction_filter` function
        ## will be called with the transaction hash:
    ...
    test_on_filter_with_only_event_name(web3,
                                        sleep_interval,
                                        emitter,
                                        Emitter,
                                        wait_for_transaction,
